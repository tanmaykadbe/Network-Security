from networksecurity.exception.exception import NetworkSecurtityException
from networksecurity.logging.logger import logging 

#COnfiguration of the data data ingestion config
...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self):
        """
        To read data from MongoDB and convert it to a pandas dataframe
        """
        try:
    ...
    def initiate_data_ingestion(self):
      try:
        dataframe = self.export_collection_as_dataframe()  # Read data from MongoDB
